...
const classSubjectData = Array.from({ length: 50 }, (_, index) => ({
  id: index + 1,
  className: "11th",
  section: "C",
  inCharge: "Ravi Singh",
  compulsorySubject: "Maths, Science, Social Science",
  optionalSubject: "Sanskrit, Marathi",
}));
...
export default function ClassSubjectTable() {
  ...
  const filteredData = classSubjectData.filter((classInfo) =>
    ...
    <div className="mx-4 p-3 space-y-6">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline">Excel Download</Button>
          <select
        ...
        <Table>
          <TableHeader className="bg-gray-50">
            <TableRow>
              ...
              <TableHead className="w-[150px] text-xs">Compulsory Subject</TableHead>
              <TableHead className="w-[150px] text-xs">Optional Subject</TableHead>
            ...
            <TableBody>
              {paginatedData.map((classInfo) => (
                <TableRow key={classInfo.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="w-[150px] p-4 text-sm">{classInfo.compulsorySubject}</TableCell>
                  <TableCell className="w-[150px] p-4 text-sm">{classInfo.optionalSubject}</TableCell>
