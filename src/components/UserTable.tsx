      ...
      <Table className="w-full">
        <TableHeader className="bg-gray-100">
          <TableRow>
            ...
            <TableHead className="text-xs">Admission ID</TableHead>
          ...
          {Array(25)
            ...
            .map((user, index) => (
              <TableRow key={index}>
                ...
                <TableCell className="p-2 text-sm">{user.class}</TableCell>
                <TableCell className="p-2">
                  <p className="text-sm">{user.guardian.name}</p>
                  <p className="text-xs text-blue-700">{user.guardian.phone}</p>
                </TableCell>
                <TableCell className="p-2 text-sm">{user.DOB}</TableCell>
